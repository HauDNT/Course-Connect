...
namespace Course_Connect.ChuongTrinhChinh_GiangVien.GiangVien
{
    public partial class ThongTinCaNhan : Form
    {
        ...
        string sourceString = "SELECT * " +
                              ...
                              "AND TaiKhoanGiangVien.username = '" + Decentralization.thisUsername + "'";
        ...
        void LoadDataToForm()
        {
            ...
            txt_MaGV.Text = ThongTin.Rows[0][0].ToString();
            ...
            txt_HocVi.Text = ThongTin.Rows[0][7].ToString();
        ...
        private void btn_Edit_TK_Click(object sender, EventArgs e)
        {
        ...
        private void btn_Luu_TK_Click(object sender, EventArgs e)
        {
            ...
            {
                DatabaseInteract.update = "UPDATE TaiKhoanGiangVien " +
        ...
        {
            if (txt_HoTen.Text == "" || txt_GioiTinh.Text == "" || txt_HocVi.Text == "" || txt_Email.Text == "" || txt_SoDT.Text == "")
                MessageBox.Show("Bạn không được bỏ trống thông tin", "Thông báo");
            else
            {
                DatabaseInteract.update = "UPDATE ThongTinGiangVien " +
                                          ...
                                          "', HocVi = N'" + FormValidate.FormatString(txt_HocVi.Text) +
                                          "', Email = '" + txt_Email.Text.Trim() +
                                          "', SoDT = '" + txt_SoDT.Text.Trim() + 
                                          "' WHERE MaGV = '" + Decentralization.LayMaNguoiDung(Decentralization.thisUsername, Decentralization.accountType) + "'";
                DatabaseInteract.command = new SqlCommand(DatabaseInteract.update, DatabaseInteract.connect);
                DatabaseInteract.command.ExecuteNonQuery();
